...
namespace Tests
{
    public class TafConfigurationTests : IClassFixture<TestFixture>
    {
        ...
        public TafConfigurationTests(TestFixture fixture)
        {
            this.fixture = fixture;

            log = LogManager.GetLogger("TafConfigUI");
            ...
            sideBarSteps = new SystemConfigSideBarSteps(log);

            guideSettingsSteps = new GeneralSettingsGuidesSteps(log);

            guideSteps = new GuideSteps(log);

            commonSteps = new SystemConfigCommonSteps(log);
        ...
        public void FeaturesActivationCheck()
        {
            ...
            browserSteps.OpenAppDeepLink(App.SystemConfiguration);

            string e2 = new AppearanceAndLayoutDashboardSettingsSteps(log).SetRecentDevicesNumber(6);
